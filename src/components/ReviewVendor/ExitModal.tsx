...
const ExitModal = () => {
  ...
  return (
    <>
      <div className="text-brand-link flex items-center mt-10 cursor-pointer" onClick={() => setOpen(true)}>
        <IoIosArrowBack />
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="px-6 md:px-20">
                <p className="font-medium text-lg text-center">Leaving this page could mean losing your review.</p>
              </ModalBody>
