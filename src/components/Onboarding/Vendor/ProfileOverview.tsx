      ...
      <div className="py-9 px-20 max-md:px-10 flex flex-col gap-7 w-full">
        ...
        <div className="flex flex-col gap-7 max-w-[560px]">
          ...
          <div className="flex w-full items-center gap-7">
            {profileImage ? (
              ...
              <CgProfile
                // size={105}
                color="#929495"
                className="w-[105px] max-md:w-[70px] h-[105px] max-md:h-[70px]"
              />
            )}
            <label
              htmlFor="file-upload"
              className="cursor-pointer font-medium text-lg max-md:text-base text-brand py-3 px-8 max-md:px-3 rounded-lg"
              style={{
          ...
          <label
            ...
            className="mb-2 max-md:mt-3 font-semibold text-lg text-gray-700"
          >
          ...
          <textarea
            ...
            className="p-3 border-1 border-[#A8A8A8] rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-muted2 focus:border-brand-muted2 resize-none text-lg font-medium max-md:text-sm"
            rows={5}
          />
        </div>
      </div>
