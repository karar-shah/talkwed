    ...
    <div className="flex justify-center items-center w-full h-full">
      <div className="w-full max-w-screen-md mx-auto md:max-w-2/3 border-slate-600 shadow-md rounded-md m-16 py-12 px-16">
        <div className="flex flex-col md:px-16">
          <h1 className="text-center text-xl font-bold text-[#585858] mb-10">Login to TalkWed</h1>
          <Input
            size="md"
            variant="bordered"
            type="email"
          ...
          <div className="flex justify-between">
            ...
            />
            <Link href="/forgot-password" className="text-[#6B14A6]">Forgot password?</Link>
          </div>
          <Button
          ...
          <div className="w-full flex items-center justify-center">
            <p className="mt-4">
              Don't have an account? <Link href="/signup" className="text-[#6B14A6]"> sign up </Link>{" "}
            </p>
          </div>
        </div>
      </div>
