...
export type MODAL_SIZE =
  ...
  | "5xl"
  | "full";
type MODAL_VIEWS = "GET_DEAL" | "AVAILABILITY" | "MESSAGE_VENDOR" | "SHARE" | "DELETE_TASK" | "CLIENT_MESSAGE_VENDOR" | "REMOVE_VENDOR" |"ADD_VENDOR" | "DELETE_ACCOUNT" | "SAVE_LINK" | "CREATE_CUSTOM_DEAL" | "EDIT_CUSTOM_DEAL";
interface openState {
  modal?: MODAL_VIEWS;
  title: string;
  subTitle?: string;
